...
[![ha-ikuai version](https://img.shields.io/badge/ikuai-2026.2.13-blue.svg)](https://github.com/dscao/ikuai)
...
2.  **控制功能**：
    ...
    * **网络开关**：ARP 绑定限制、流控模式切换、自定义开关（ikuai中个性化配置有关，比如：NAS 分流开关）。
...
> 📖 **[查看高阶教程：如何添加自定义 iKuai 开关实体](docs/ADVANCED_GUIDE.md)**
